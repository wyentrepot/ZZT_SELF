 ...
 * 数据源与经典视图共用同一索引库：/api/listener/logs/frames（列表）、/api/listener/logs/frames/{id}（详情+feature_hint）。
...
(function () {
  ...
  function loadFrames() {
    ...
    request(`/api/listener/logs/frames?${params}`).then((page) => {
  ...
  function selectFrame(id) {
    ...
    request(`/api/listener/logs/frames/${id}`).then((f) => {
